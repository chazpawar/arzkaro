...
export const ALL_MOCK_EVENTS: MockEventItem[] = [
  {
    ...
    genre: 'acoustic',
    description:
      'Get ready for an unforgettable night as Shivam brings his soulful voice, raw emotion, and high-energy performance to the stage. Venue will be announced soon — stay tuned for the reveal. One thing’s guaranteed: it’s going to be a night full of music, memories, and pure vibes.',
    includes: [
      'Concert Entry (Tickets)',
      'Exclusive Merch Discount Voucher (10%)',
      'Full Group Chat Access',
    ],
    notes: [
      'Venue will be announced 2 weeks prior to the event date.',
      'A valid government-issued ID is mandatory for entry.',
  ...
  },
  {
    ...
    genre: 'rock',
    description:
      "Post Malone fans, this one's for you, Delhi! 🎤 \
...
Let’s get loud, weird, and unapologetically us. 🤘",
    ...
    notes: [
      'Venue details expected to be released 7 days before the show.',
      'No professional cameras allowed.',
      'Late entry will be permitted until 9:00 PM.',
    ],
