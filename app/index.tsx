    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Your React Native Expo app with Supabase Auth</Text>
          {user.email && <Text style={styles.userEmail}>Signed in as: {user.email}</Text>}
        </View>
        ...
        <Card style={styles.card}>
          ...
          <Text style={styles.cardText}>
            This app uses a custom design system with consistent colors, typography, spacing, and
            reusable components.
          </Text>
        </Card>
        ...
        <View style={styles.buttonContainer}>
          ...
          <Button
            ...
            size="large"
          />
          <Button title="Sign Out" onPress={signOut} variant="outline" size="large" />
        </View>

        <View style={styles.footer}>
          <Text style={styles.footerText}>Built with ❤️ using Expo, React Native & Supabase</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
